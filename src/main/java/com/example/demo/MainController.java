...
public class MainController {
    ...
    @GetMapping(path = "/")
    public @ResponseBody String home(){return "Luffy - Monkey D Luffy";}

    @GetMapping(path = "/codigo")
    public @ResponseBody String codigo(){return "Luffy";}

    @GetMapping(path = "/nombre-completo")
    public @ResponseBody String nombre(){return "Monkey D Luffy";}
